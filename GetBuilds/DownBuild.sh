...
if [ sshpass -p iltwat ssh root@${IPAR[$ix]} "[ -d /home/ems/$tobuild ]" ] && [ $tobuild != '' ]
then
echo 'build directory exists'


sshpass -p iltwat ssh root@${IPAR[$ix]} "test -f  /home/ems/$tobuild/EMS* -a -f /home/ems/$tobuild/Dep* -a -f /home/ems/$tobuild/inst* -a -f /home/ems/$tobuild/NMS*"
...
sshpass -p iltwat ssh root@${IPAR[$ix]} "mkdir /home/ems/$tobuild"
bflag=1
fi
...
sshpass -p iltwat ssh root@${IPAR[$ix]} << EOF
cd /home/ems/$tobuild
